...
// Channel.Events.cs is distributed under the Microsoft Public License (MS-PL)
// 
...
namespace FMOD.NET.Core
{
	public partial class Channel
	{
		...
		/// <summary>
		///     Raises the <see cref="ChannelGroupChanged" /> event.
		/// </summary>
		/// <seealso cref="EventArgs" />
		protected virtual void OnChannelGroupChanged()
		{
