...
// DspParameterDescBool.cs is distributed under the Microsoft Public License (MS-PL)
// 
...
namespace FMOD.NET.Structures
{
	...
	public struct DspParameterDescBool
	{
		...
		/// <summary>
		///     <para>Names for <c>false</c> and <c>true</c>, respectively.</para>
		///     <para>There should be two strings. Optional.</para>
		/// </summary>
