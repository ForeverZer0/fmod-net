...
// DspParameterDescFloat.cs is distributed under the Microsoft Public License (MS-PL)
// 
...
namespace FMOD.NET.Structures
{
	...
	public struct DspParameterDescFloat
	{
		...
		/// <summary>
		///     How the values are distributed across dials and automation curves (e.g. linearly, exponentially etc).
		/// </summary>
