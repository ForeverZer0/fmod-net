...
// DspParameterSideChain.cs is distributed under the Microsoft Public License (MS-PL)
// 
...
namespace FMOD.NET.Structures
{
	...
	///     <para>A parameter of this type is declared for effects which support sidechaining.</para>
	/// </summary>
	...
	{
		/// <summary>
		///     Indicates whether sidechains are enabled.
		/// </summary>
