...
// FloatMapping.cs is distributed under the Microsoft Public License (MS-PL)
// 
...
namespace FMOD.NET.Structures
{
	...
	public struct FloatMapping
	{
		...
		///     <para>Only required for if <see cref="Type" /> property is <see cref="FloatMappingType.PiecewiseLinear" />.</para>
		/// </summary>
