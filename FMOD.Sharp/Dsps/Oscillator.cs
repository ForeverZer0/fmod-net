	...
	public class Oscillator : Dsp
	{
		...
		public WaveformType OscillatorType
		{
			...
			set
			{
				...
				OscilallatorTypeChanged?.Invoke(this, new DspOscillatorTypeChangedEventArgs(0, value));
			}
		}
		...
		/// </summary>
		/// <seealso cref="DspOscillatorTypeChangedEventArgs" />
		/// <seealso cref="WaveformType" />
		public event EventHandler<DspOscillatorTypeChangedEventArgs> OscilallatorTypeChanged;
