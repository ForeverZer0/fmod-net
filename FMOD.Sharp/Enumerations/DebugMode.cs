...
// DebugMode.cs is distributed under the Microsoft Public License (MS-PL)
// 
...
namespace FMOD.Enumerations
{
	...
	/// </summary>
	/// <remarks>
	///     TTY destination can vary depending on platform, common examples include the Visual Studio / Xcode output
	///     window, stderr and LogCat.
	/// </remarks>
