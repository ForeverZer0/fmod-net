...
namespace FMOD.Sharp.Enums
{
	...
	public enum DspConnectionType 
    {
		...
		/// </summary>
		/// <remarks>
		/// <para>Default <see cref="DspConnection"/> type. Audio is mixed from the input to the output <see cref="Dsp"/>'s audible buffer, meaning it will be part of the audible signal. </para>
		...
		/// </summary>
		/// <remarks>
		/// <para>Sidechain <see cref="DspConnection"/> type. Audio is mixed from the input to the output <see cref="Dsp"/>'s sidechain buffer, meaning it will NOT be part of the audible signal. A sidechain connection will execute its input DSP if it has not been executed before.</para>
		...
		/// <para>Audio is mixed from the input to the output <see cref="Dsp"/>'s audible buffer, but the input is <b>NOT</b> executed, only copied from. A standard connection or sidechain needs to make an input execute to generate data.</para>
		/// </summary>
		/// <remarks>
		/// <para>Send <see cref="DspConnection"/> type. Audio is mixed from the input to the output <see cref="Dsp"/>'s audible buffer, meaning it will be part of the audible signal. A send connection will <b>NOT</b> execute its input DSP if it has not been executed before</para>
		...
		/// <para>Audio is mixed from the input to the output <see cref="Dsp"/>'s sidechain buffer, but the input is <b>NOT</b> executed, only copied from. A standard connection or sidechain needs to make an input execute to generate data.</para>
		/// </summary>
		/// <remarks>
		/// <para>Send sidechain <see cref="DspConnection"/>  type. Audio is mixed from the input to the output <see cref="Dsp"/>'s sidechain buffer, meaning it will <b>NOT</b> be part of the audible signal. A send sidechain connection will <b>NOT</b> execute its input DSP if it has not been executed before.</para>
