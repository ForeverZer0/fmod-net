...
// DspParameterAttributes3D.cs is distributed under the Microsoft Public License (MS-PL)
// 
...
{
	/// <summary>
	///     <para>Structure for data parameters of type <see cref="DspParameterDataTypes.Attributes3D" />.</para>
	///     <para>A parameter of this type is used in effects that respond to a 3D position.</para>
	/// </summary>
	/// <remarks>
	///     <para>
